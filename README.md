...
一个纯前端、麦克风驱动的头像展示面板。页面包含 246 个头像，可根据麦克风音量让当前头像轻微缩放和上浮，不使用 AI，也不会上传音频。
...
这是一个非官方项目，与 Voicemod 无隶属或背书关系。公开发布仓库前，请确认你拥有 `assets/portraits` 中素材的再分发权；不要默认代码许可会同时覆盖第三方图片素材。
